  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
       ...
       <form class="form-validate" id="form1" name="form3" method="post" action="deduction_script.php">
       ...
       <div class="form-group">
         ...
         <input type="text" name="desc"  value="" class="form-control" pattern ="[A-Za-z]{5,}" title="(no spaces, numbers or special characters. more than 5 characters)" required>
       </div>
       <div class="form-group">
         <label for="exampleInputPassword1">Amount</label>
         <input type="number" name="amount" value="" class="form-control" id="exampleInputPassword1" min="150" max="3000" required>
       </div>
